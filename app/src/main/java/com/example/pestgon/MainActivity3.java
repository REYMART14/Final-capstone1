...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (pest.equals("Brown Planthopper")) {
            tView.setMovementMethod(new ScrollingMovementMethod());
            tView.setText("Why and where it occurs\n" +
        ...
        } else if (pest.equals("Golden Apple Snail")) {
            tView.setMovementMethod(new ScrollingMovementMethod());
            tView.setText("Why and where it occurs\n" +
        ...
        } else if (pest.equals("Green Planthopper")) {
            tView.setMovementMethod(new ScrollingMovementMethod());
        ...
        } else if (pest.equals("Rice Mealy bug")) {
            tView.setMovementMethod(new ScrollingMovementMethod());
            tView.setText(
                    "Why and where it occurs\n" +
        ...
        } else if (pest.equals("Stem Borer")) {
            tView.setMovementMethod(new ScrollingMovementMethod());
            tView.setText("Why and where it occurs\n" +
        ...
        } else if (pest.equals("Water Weevil")) {
            tView.setMovementMethod(new ScrollingMovementMethod());
            tView.setText(
                    "Why and where it occurs\n" +
        ...
        } else if (pest.equals("White Planthopper")) {
            tView.setMovementMethod(new ScrollingMovementMethod());
            tView.setText(
                    "Why and where it occurs\n" +
                            "\n" +
        ...
        camera1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(MainActivity3.this, Camera.class);
        ...
        pest1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity3.this, HomeMainActivity3.class);
